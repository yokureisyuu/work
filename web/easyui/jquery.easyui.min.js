...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,missingMessage:"输入内容不能为空.",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,tipOptions:{showEvent:"none",hideEvent:"none",showDelay:0,hideDelay:0,zIndex:"",onShow:function(){
...
return len>=_445[0]&&len<=_445[1];
},message:"输入内容长度必须介于{0}和{1}之间."},price:{
	...
	message : "请输入优惠折扣，格式如95,表示按原价的95%销售"
		...
		validator : function(value){
		return /^[(\u0391-\uFFE5)|\w]{2,10}$/i.test(value);
	},
	message : "名称必须为2到10个汉字或字母或数字"
	},phone:{
		validator : function(value){
