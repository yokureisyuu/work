...
<style type="text/css">
<!--
BODY {	PADDING-RIGHT: 0px; PADDING-LEFT: 35px; BACKGROUND: url(photoback.gif) repeat-x left top; PADDING-BOTTOM: 0px; MARGIN: 0px; FONT: 12px Arial, Helvetica, sans-serif; COLOR: #333; PADDING-TOP: 35px}
...
.img404 {PADDING-RIGHT: 0px; PADDING-LEFT: 0px; BACKGROUND: url(${pageContext.request.contextPath}/public/images/icons/404.gif) no-repeat left top; FLOAT: left; PADDING-BOTTOM: 0px; MARGIN: 0px; WIDTH: 80px; PADDING-TOP: 0px; POSITION: relative; HEIGHT: 90px}
