...
<link rel="stylesheet" href="template/images/common.css">
<link rel="stylesheet"
...
<body>
	<div class="wrapper">
		<div class="pages">
			...
			<s:if test="%{#request.sceneryone.sceneryPic2!=null}">
				<section class="page page1">
					<div class="page-con">
						<img style="width: 100%; height: 100%;"
							src="<s:property value='#request.sceneryone.sceneryPic2'/>" />
					</div>
				</section>
			</s:if>
			<s:if test="%{#request.sceneryone.sceneryPic3!=null}">
				<section class="page page1">
					<div class="page-con">
						<img style="width: 100%; height: 100%;"
			...
			<s:if test="%{#request.sceneryone.sceneryPic4!=null}">
				<section class="page page1">
					<div class="page-con">
						<img style="width: 100%; height: 100%;"
							src="<s:property value='#request.sceneryone.sceneryPic4'/>" />
					</div>
				</section>
			</s:if>
			<s:if test="%{#request.sceneryone.sceneryPic5!=null}">
				<section class="page page1">
					<div class="page-con">
						<img style="width: 100%; height: 100%;"
							src="<s:property value='#request.sceneryone.sceneryPic5'/>" />
					</div>
				</section>
			</s:if>
