...
public class MediaUtil extends CommonUtil {
	 ...
	 * @param mediaFileUrl
	 *            媒体文件url(如：localhost:8080/test/upload/music.mp3)
	 * @return Media
	 */
	public static Media uploadMedia(String accessToken, String type,
			String mediaFileUrl) {
		Media weixinMedia = null;
		String uploadMediaUrl = UPLOAD_MEDIA_URL.replace("ACCESS_TOKEN",
	...
	public static void main(String[] args) {
		...
		// 上传多媒体文件
		Media weixinMedia = uploadMedia(accessToken, "image",
				"http://silktravel.56jyt.com/weixin/images/qrcode_for_silktravel.jpg");
